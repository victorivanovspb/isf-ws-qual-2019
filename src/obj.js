...
class Obj  {
     ...
     * значение currentRate. При достижении величины 100 просиходит "переход" на новое состояние с обнулением currentRate.
     * В случае, когда все состояния пройдены, то объект объявляется "заполненным" (complete = true) и отныне возвращается
     * только значение null.
     * @returns {null|object}
     */
    getNext() {
        if (this.complete) {
